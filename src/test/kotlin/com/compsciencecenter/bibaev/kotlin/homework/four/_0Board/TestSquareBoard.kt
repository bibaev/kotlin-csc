...
import com.compsciencecenter.bibaev.kotlin.homework.four._0Board.createSquareBoard
...
class TestSquareBoard {
    ...
    fun testIndices() {
        ...
        Assert.assertEquals(16, indices.size)
        Assert.assertEquals(1, indices[0].first)
        Assert.assertEquals(1, indices[0].second)

        Assert.assertEquals(1, indices[1].first)
        Assert.assertEquals(2, indices[1].second)

        Assert.assertEquals(4, indices[15].first)
        Assert.assertEquals(4, indices[15].second)
    }
}
